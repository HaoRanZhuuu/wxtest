...
public class MenuSetting {
	...
	public static String appId = "wx3c6e1ad47a7d44ff";
    public static String appSecret= "355ee585402b17b80f4fb92c772a8a0b"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://2144922fn7.iok.la/MysqlTset/question.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
